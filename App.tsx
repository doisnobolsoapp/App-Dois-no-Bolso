...
const TransactionList = lazy(() => 
  import('./components/TransactionList').then(module => ({ default: module.TransactionList }))
);
const Goals = lazy(() => 
...
const FinancialCalendar = lazy(() => 
  import('./components/FinancialCalendar').then(module => ({ default: module.FinancialCalendar }))
);
const BankList = lazy(() => 
  import('./components/BankList').then(module => ({ default: module.BankList }))
);
const CreditCardList = lazy(() => 
  import('./components/CreditCardList').then(module => ({ default: module.CreditCardList }))
);
const InvestmentDashboard = lazy(() => 
  import('./components/InvestmentDashboard').then(module => ({ default: module.InvestmentDashboard }))
);
